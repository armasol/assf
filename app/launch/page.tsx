...
export default function LaunchPage() {
  ...
  const connectAndLaunch = async () => {
    ...
    try {
      ...
      window.alert('Wallet connection or network switch was cancelled.');
    }
  };
  ...
  return <div className="page-wrap content-page launch-page">
    <Reveal><div className="launch-heading"><div className="eyebrow">LAUNCH ON PONS · ROBINHOOD CHAIN MAINNET</div><h1>Launch a creator-linked token.</h1><p>Connect MetaMask to prepare a free launch on Robinhood Chain Mainnet. Network gas may still apply; Pons launch execution is the next transaction step.</p></div></Reveal>
