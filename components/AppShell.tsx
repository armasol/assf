    ...
    <div className={`app-shell ${collapsed ? 'sidebar-collapsed' : ''}`}>
      <aside className={`sidebar ${mobileOpen ? 'mobile-open' : ''}`}>
        ...
        <div className="sidebar-foot">
          ...
          {!collapsed && <div><strong>subbed</strong><span>Creator fees on Twitch</span><a className="social-link" href="https://x.com/trysubbed" target="_blank" rel="noreferrer">@trysubbed on X</a></div>}
        </div>
      </aside>
